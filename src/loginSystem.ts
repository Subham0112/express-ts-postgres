...
import {register,login,getUser,refreshToken,forgetPassword,verifyOtp,resetPassword,getAllUsers, logout, resendOtp, passwordChange,deleteUser,logoutFromAll,uploadMedia} from "./controllers/login.controller.js";
...
app.post("/upload-media",uploadMedia);
